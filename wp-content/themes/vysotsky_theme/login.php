    ...
    <div class="modal-content" id="superform">
      ...
      <div class="form-group" style="margin-top:30px;">
        <form name="loginform" class="lwa-form" id="loginform" action="http://bim.vc/auth.php" method="post">
          ...
          <div class="col-sm-4 pull-right" style="text-align: right;margin-top: 27px;padding: 0;"><a id="rp" href="#">Забыли пароль?</a> </div>
        ...
        '.do_shortcode("[passwordless-login]").' 
        </div>
    </div>
  </div>
</div>
      ...
      <div class="lwa">
        <form class="lwa-form" style="margin-top:30px;" name="lwa-register" id="registerform" action="http://bim.vc/auth.php?action=register" method="post" novalidate="novalidate">
          <div class="form-group" id="superform2">
            ...
            <input placeholder="Придумайте пароль" type="password" name="cimy_uef_wp_PASSWORD" id="cimy_uef_wp_3" class="form-control cimy_uef_input_27" value="" maxlength="100">
            <input placeholder="Имя" type="text" name="cimy_uef_wp_FIRSTNAME" id="cimy_uef_wp_5" class="form-control cimy_uef_input_27" value="" maxlength="100">
            <input placeholder="Фамилия" type="text" name="cimy_uef_wp_LASTNAME" id="cimy_uef_wp_6" class="form-control cimy_uef_input_27" value="" maxlength="100">
            <input placeholder="Компания/ВУЗ" type="text" name="cimy_uef_Компания" id="cimy_uef_6" class="form-control cimy_uef_input_27" value="" maxlength="100">
            <input placeholder="Город" type="text" name="cimy_uef_Город" id="cimy_uef_2" class="form-control cimy_uef_input_27" value="" maxlength="50">
